...
def _protocol_message(reason, ledger_dir):
    ...
    return (
        ...
        "   NOTE: in Dropbox/OneDrive/iCloud folders the ReparsePoint bit false-positives on nearly "
        "every synced file. A REAL link populates LinkType AND Target; a cloud placeholder leaves "
        "both empty. Filter with: ... | Where-Object { $_.LinkType }  before calling it an escape.\n"
